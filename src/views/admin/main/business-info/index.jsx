...
const Business=()=>{
    ...
    return(
        ...
        <div class="w-full px-10 mt-5 mb-10">
              ...
              <div className="flex w-full flex-row  rounded-[20px] bg-cover bg-no-repeat px-[15px] py-[20px] md:px-[64px] md:py-[30px] bg-[#E8EBFF]"
      >
                <div class="flex">
                  <i class="fa-solid fa-check bg-[#18C385] mt-1 p-[7px] text-white text-[18px] rounded-full w-[30px] h-[30px]"></i> 
                  <strong class="text-lg font-bold text-black pl-2 mt-2 ">Claimed</strong> 
                </div>            
                <span class="mt-1 text-black rounded-md text-md p-2 border border-solid border-[#d0efdb] mt-2 ml-10 lg:mt-0 block lg:inline">
            ...
            <div class="w-full lg:wd-4/5 lg:pdl-3">
              ...
              <div class="relative bg-[white] p-10 rounded-lg border border-gray-200 pt-15 shadow-xl shadow-gray-300  min-h-[300px]">
                ...
                <div class="w-full lg:grid grid-cols-2 gap-5">
                  ...
                  <div class="w-full">
                    <div class="w-full p-7  rounded-[20px] mb-3 lg:mb-0 bg-[#E3F5FF] min-h-[700px]" >
                      <div class="flex flex-col items-start justify-between space-x-2 mb-2">
                        <div class="text-xl font-bold text-[#031390] ml-2 ">  <i class="fa-solid fa-location-dot  p-2 rounded-full"></i> Business Details</div>
                        <p class="text-[16px] text-black  mb-4 ml-3">Google Business Profile is one of the most important optimization tools that can help your business to appear and rank higher on Google Search and Google Maps.</p>
                        
                      </div>
                      <div class="w-full pr-0 lg:pr-0 bg-[white] min-h-[600px] rounded-[12px]">
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">Name</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">                    
                          Chess House Dental Practice
                          </span>
                        </div>
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">Address</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                        ...
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">City</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                          Chesham
                          </span>
                        </div>
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">State</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                          Buckinghamshire
                          </span>
                        </div>
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">Country, Zipcode</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                          GBR,HP5 1DE
                          </span>
                        </div>
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">Phone</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                          +44 1494 771856
                          </span>
                        </div>
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">Email</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                          INFO@CHESSHOUSEDENTAL.COM
                          </span>
                        </div>
                        <div class="py-2 border-solid bg-[white] p-5 rounded-[20px]  border-gray-200 mt-2">
                          <span class="block text-md font-bold mb-1 text-[#031390]">Website</span>
                          <span class="text-black text-sm font-normal leading-[13.41px]">
                  ...
                  <div class="w-full p-7  rounded-[20px] mb-3 lg:mb-0 bg-[white] shadow-xl shadow-gray-300"  >
                  ...
                  <div class="w-full">
                    ...
                    <div class="grid grid-cols-4 gap-10 score md:grid-cols-4 sm:grid-cols-2">
